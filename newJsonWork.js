const jsonFile = {
    '49ers':{
		...
		passing: {
			total_passing_yards: 3925,
			total_passing_touchdowns: 15
		},
		special_teams: {
    ...
    'Bears':{
		...
		rushing: {
			...
			total_rushing_touchdowns: 13
		},
		passing: {
			total_passing_yards: 2811,
			total_passing_touchdowns: 13
		},
		special_teams: {
    ...
    'Bengals':{
		...
		passing: {
			total_passing_yards: 3122,
			total_passing_touchdowns: 25
		},
		special_teams: {
    ...
    'Bills':{
		...
		rushing: {
			...
			total_rushing_touchdowns: 12
		},
		passing: {
			total_passing_yards: 2825,
			total_passing_touchdowns: 16
		},
		special_teams: {
    ...
    'Broncos':{
		...
		passing: {
			total_passing_yards: 3333,
			total_passing_touchdowns: 19
		},
		special_teams: {
    ...
    'Browns':{
		...
		rushing: {
			...
			total_rushing_touchdowns: 11
		},
		passing: {
			total_passing_yards: 3228,
			total_passing_touchdowns: 15
		},
		special_teams: {
    ...
    'Buccaneers':{
		...
		passing: {
			total_passing_yards: 4366,
			total_passing_touchdowns: 26
		},
		special_teams: {
    ...
    'Cardinals':{
		...
		passing: {
			total_passing_yards: 3640,
			total_passing_touchdowns: 21
		},
		special_teams: {
    ...
    'Chargers':{
		...
		rushing: {
			...
			total_rushing_touchdowns: 10
		},
		passing: {
			total_passing_yards: 4431,
			total_passing_touchdowns: 28
		},
		special_teams: {
    ...
    'Cowboys':{
		...
		rushing: {
			...
			total_rushing_touchdowns: 18
		},
		passing: {
			total_passing_yards: 3141,
			total_passing_touchdowns: 22
		},
		special_teams: {
    ...
    'Dolphins':{
		...
		passing: {
			total_passing_yards: 3535,
			total_passing_touchdowns: 24
		},
		special_teams: {
    ...
    'Eagles':{
		...
		passing: {
			total_passing_yards: 3737,
			total_passing_touchdowns: 38
		},
		special_teams: {
    ...
    'Giants':{
		...
		passing: {
			total_passing_yards: 3479,
			total_passing_touchdowns: 20
		},
		special_teams: {
    ...
    'Lions':{
		...
		passing: {
			total_passing_yards: 4183,
			total_passing_touchdowns: 29
		},
		special_teams: {
    ...
    'Patriots':{
		...
		passing: {
			total_passing_yards: 4418,
			total_passing_touchdowns: 32
		},
		special_teams: {
    ...
    'Rams':{
		...
		rushing: {
			...
			total_rushing_touchdowns: 17
		},
		passing: {
			total_passing_yards: 3831,
			total_passing_touchdowns: 28
		},
		special_teams: {
    ...
    'Ravens':{
		...
		rushing: {
			...
			total_rushing_touchdowns: 14
		},
		passing: {
			total_passing_yards: 3030,
			total_passing_touchdowns: 20
		},
		special_teams: {
    ...
    'Redskins':{
		...
		passing: {
			total_passing_yards: 3751,
			total_passing_touchdowns: 27
		},
		special_teams: {
    ...
    'Seahawks':{
		...
		passing: {
			total_passing_yards: 3657,
			total_passing_touchdowns: 34
		},
		special_teams: {
    ...
    'Titans':{
		...
		passing: {
			total_passing_yards: 3191,
			total_passing_touchdowns: 14
		},
		special_teams: {
